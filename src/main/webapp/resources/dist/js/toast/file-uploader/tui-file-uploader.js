...
/***/ (function(module, exports) {
	 ...
	 */
	module.exports.html = {
	    FORM: '', //'<form enctype="multipart/form-data" id="tui-uploader-form" name="tui-uploader-form" method="post"></form>',
	...
	module.exports.tableTemplate = {
	    CONTAINER: [
	        '<table class="tui-file-uploader-tbl">',
	            ...
	            '<thead class="tui-form-header">',
	                '<tr>',
	                    '<th scope="col" width="5%" style="border-right:0;">{{checkbox}}</th>',
	                    '<th scope="col" width="15%">파일타입</th>',
	                    '<th scope="col" width="65%">파일명</th>',
	                    '<th scope="col" width="" style="border-right:0">파일사이즈</th>',
	                '</tr>',
	            '</thead>',
	            '<tbody class="tui-form-body {{listItemsClassName}}"></tbody>',
	        '</table>'
	    ...
	    CONTAINER: [
	        '<table class="tui-file-uploader-tbl">',
	            ...
	            '<thead class="tui-form-header">',
	                '<tr>',
	                    '<th scope="col" width="5%" style="border-right:0;">{{checkbox}}</th>',
	                    '<th scope="col" width="10%" style="border-right:0;">상태</th>',
	                    '<th scope="col" width="">파일명</th>',
	                '</tr>',
	            '</thead>',
	            '<tbody class="tui-form-body {{listItemsClassName}}" id="tui-form-body"></tbody>',
	        '</table>'
	    ].join(''),
	    LIST_ITEM: [
	        '<tr>',
	            '<td width="5%">',
	                '<label class="tui-checkbox">{{checkbox}}</td>',
	            '<td width="10%" style="text-align:center;">신규</td>',
	            '<td width="">',
	                '<span class="tui-filename-area">',
	                    '<span class="tui-file-name">{{filename}}</span>',
	                '</span>',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var List = snippet.defineClass(/** @lends List.prototype */{
	    ...
	    _onChange: function() {
	        ...
	        if(state){
	        	//체크
	        	$('input:checkbox[name="delFile"]').each(function() {
	        		var $labels = $(this).parents('label');
	        		$labels.addClass("tui-is-checked");
	        	...
	        	$('input:checkbox[name="delFile"]').each(function() {
	        		var $labels = $(this).parents('label');
	        		$labels.removeClass("tui-is-checked");
	        		this.checked = false; 
	        	});
	        }
	    },
